...
exports.login = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var body, email, attempt, user, valid, secret, _a, email_1, phone, _id, token, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                body = req.body;
                email = body.email, attempt = body.password;
                return [4 /*yield*/, user_1.default.findOne({ email: email })];
            case 1:
                user = _b.sent();
                return [4 /*yield*/, (user === null || user === void 0 ? void 0 : user.comparePasswords(attempt))];
            case 2:
                valid = _b.sent();
                if (user != null && valid) {
